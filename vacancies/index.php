...
$vacancies = $db->query($query)->fetchAll(PDO::FETCH_ASSOC);
?>
<!doct<!doctype html>
                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="Appointment">
                                ...
                                <div class="d-none d-lg-block">
                                    <a class="boxed-btn3" href="create_vacancy.php">Post a Job</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <div class="job_sumary">
                    ...
                    <div class="job_content">
                        <ul>
                            ...
                            <li>Salary: <span><?= salaryFormat($vacancy['salary_from']) ?> - <?=salaryFormat($vacancy['salary_to'])?></span></li>
