                    ...
                    <div class="job_details_header">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                <div class="thumb">
                                    <img src="<?=trim($vacancy['user_photo_path'],"./")?>" alt="avatar">
                                </div>
                    ...
                    <div class="apply_job_form white-bg">
                        ...
                        <form action="response.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <input type="text" placeholder="Website/Portfolio link" name="url">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="submit_btn">
                                        <input type="submit" value="Отправить" class="btn-primary" style="width: 650px; height: 50px;border-radius: 10px">
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="col-lg-4">
                    <div class="job_sumary">
                        ...
                        <div class="job_content">
                            <ul>
                                <li>Published on: <span><?=$vacancy['publicated_at']?></span></li>
                                <li>Vacancy: <span><?=$vacancy['position']?></span></li>
                                <li>Salary: <span><?= salaryFormat($vacancy['salary_from'])?> - <?=salaryFormat($vacancy['salary_to'])?>/y</span></li>
                                <li>Location: <span><?=$vacancy['location']?></span></li>
                                <li>Job Nature: <span><?=$vacancy['type_employment_name']?></span></li>
                            </ul>
                        </div>
                    </div>
